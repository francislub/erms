                                    ...
                                    ?>
                                        ...
                                        <footer>
                                            ...
                                            <div class="card-body">
                                                    <?php
                                                    // Execute the query
                                                    $result1 = $con->query("SELECT m.name, b.batch_no FROM lecturer_enroll le 
                                                                            INNER JOIN modules m ON le.module = m.id 
                                                                            INNER JOIN batches b ON b.id = le.batch 
                                                                            WHERE le.lecturer = $id;");
