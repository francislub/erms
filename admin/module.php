    ...
    <div class="page-wrapper toggled bg2 border-radius-on light-theme">
        ...
        <div class="container">
            ...
            if (
                ...
                $sql = "INSERT INTO `modules` (`id`, `Name`, `Semester_Id`, `Course_code`, `practical_hour`,`Learning_Hours`, `Lecture_Hours`, `Self_Study_Hours`, `AIM`, `Learn`, `Resources`, `References`) 
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                ?>
                                                    <input type="text" placeholder="M02" value="<?php echo $code; ?>" name="id" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="validationServer01" required>
                                                <?php
                                            }
                                        ?>
