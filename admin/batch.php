                ...
                <div class="card  mb-3">
                    <div class="card-header bg-transparent ">
                        <div class="row">
                            ...
                            <div class="col-auto"> <a href="batches.php" class="btn btn-outline-primary">Streams</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body ">
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <select class="custom-select" name="nvq" id="inputGroupSelect01" id="validationCustom04" required>
                                                    ...
                                                    if (isset($_GET['edit'])) {
                                                        ...
                                                        <option disabled value="">Choose Education Level</option>
                                                    ...
                                                    ?>
                                                        <option selected disabled value="">Choose Education Level</option>
                                                        <option value="primary">Primary</option>
                                                        <option value="nursary">Nursary</option>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                if (isset($_GET['edit'])) {
                                                    ?>
                                                    <input type="text" readonly name="batchno" class="form-control" value="<?php echo $batchno; ?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="validationServer01" required>
                                                <?php
                                            } else {
                                                ?>
                                                    <input type="text" name="batchno" class="form-control" value="<?php echo $batchno; ?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="validationServer01" required>
                                                <?php
                                            }
                                            ?>
